    ...
    <header className="resume-header">
      <div className="header-main">
        <div className="header-identity">
          ...
          <div
            className="summary"
            dangerouslySetInnerHTML={{ __html: headerData.summary }}
          ></div>
        </div>
        <div className="header-contact">
          ...
          <div className="contact-item">
            ...
            <a href={headerData.contact.linkedin.url} target="_blank" rel="noopener noreferrer">
          ...
          <div className="contact-item">
            ...
            <a href={headerData.contact.github.url} target="_blank" rel="noopener noreferrer">
          ...
          <div className="contact-item">
            ...
            <a href={headerData.contact.youtube.url} target="_blank" rel="noopener noreferrer">
              {headerData.contact.youtube.label}
            </a>
          </div>
        </div>
      </div>
